...
function converterPrecoParaReais1(precoEmDolar1, taxaDeCambio1, iof1, lucro1) {
    ...
    var precoEmReais1 = precoEmDolar1 * taxaDeCambio1; // Conversão para reais
    var valorIOF1 = precoEmReais1 * (iof1 / 100); // Cálculo do IOF
    var precoComIOF1 = precoEmReais1 + valorIOF1; // Preço com IOF
    var precoVenda1 = precoComIOF1 * (1 + lucro1 / 100); // Preço de venda com lucro
...
var taxaDeCambio1 = 5.10; // Exemplo de taxa de câmbio
